...
const Calculator = () => {
  ...
  return (
    <div>
      ...
      {error && <div style={{ color: 'red',fontweight: '600',margin: '13px 0 13px 0'  }}>{error}</div>}
      {result && <div style={{ color: 'green', fontsize: '33px', fontweight: '600',margin: '13px 0 13px 0' }}>Result: {result}</div>}
    </div>
  );
};
